<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Lucky.aspx.cs" Inherits="PhotoData.Lucky" %>
...
<body style="margin:0; background:black; color:white; font-family:Segoe UI Light;">
    ...
    <center><span style="font-size:40pt; cursor:pointer" onclick="donavigate('years.aspx')">Parikh Family Photos</span>
                   <span style="cursor:pointer; font-size:xx-small" onclick="donavigate('lucky.aspx')">I'm feeling Lucky</span></center>
